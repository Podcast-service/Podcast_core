...
| `404` | `RESOURCE_NOT_FOUND` | Ресурс не найден или скрыт политикой доступа | Неверный id, приватный плейлист чужого пользователя, неопубликованный подкаст | Проверить id и доступ |
