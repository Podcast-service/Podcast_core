...
public class PodcastProcessingStartedHandler implements MediaWorkerEventHandler {

    private static final MediaHandlerKey<MediaWorkerEventType> KEY =
            new MediaHandlerKey<>(MediaObjectType.PODCAST_FILE_URL, MediaWorkerEventType.START_PROCESSING);
