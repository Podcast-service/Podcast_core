...
@Component
public class PlaylistUploadErrorHandler extends NoopMediaUploadEventHandler {
    public PlaylistUploadErrorHandler() {
        super(MediaObjectType.PLAYLIST, MediaUploadEventType.ERROR);
    }
}
