...
public class PodcastFileUploadStartedHandler implements MediaUploadEventHandler {

    private static final MediaHandlerKey<MediaUploadEventType> KEY =
            new MediaHandlerKey<>(MediaObjectType.PODCAST_FILE_URL, MediaUploadEventType.START_UPLOAD);
    ...
    public void handle(MediaUploadEventDto event, KafkaRecordContext context) {
        service.markFileUploadStarted(event.targetPodcastId(), event.timestamp());
    }
}
