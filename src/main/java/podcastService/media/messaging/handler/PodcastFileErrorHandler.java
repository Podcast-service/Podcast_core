...
public class PodcastFileErrorHandler implements MediaEventHandler {

    private static final MediaEventKey KEY = new MediaEventKey("podcast_file", "error");
    ...
    public void handle(MediaEvent event, KafkaRecordContext context) {
        podcastMediaMetadataService.markFileUploadError(event.objectId(), event.optionalText("error_message"));
    }
}
